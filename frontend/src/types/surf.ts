...
export type GameCreatedEvent = ExtractStructType<ABITAble, typeof CHESS_ABI, "GameCreatedEvent">;

// Constnants are not included in the ABI so we define them manually here.
